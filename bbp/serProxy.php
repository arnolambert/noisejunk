...
<table width="300px" align="center">
    ...
    <tr>
   <tr>
        <td><a class="button" href="<?=$_SERVER['PHP_SELF']?>?action=down">down</a></td>
        <td></td>
        <td><a class="button" href="<?=$_SERVER['PHP_SELF']?>?action=up">up</a></td>
    </tr>
</table>
    <?php
    if(CONNECT){
    ...
    if (isset($_GET['action'])) {
        ...
        //  0 up, 1 down
        //examples:
        // 000100000 move y one step forward (0001), x does not move (0000), marker up (0)
        // 000001230 don't move y (000), x moves 023 steps backward (0123) , marker up (0)
        // 101100221 y moves 11 steps backwards (0111), x moves 22 steps forward (0022), marker down (1)
        if ($_GET['action'] == 'left') {
            $midMsg = '000000100';
        }
